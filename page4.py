...
def p4_updateLayout():
    ...
    bot_leftSpace = html.Div([dcc.RadioItems(
        ...
        labelStyle={'display': 'inline-block', 'padding-right':'10px'}), 
        dcc.Loading( dcc.Graph(id='eu_fig'),color='#45bf55', type='default', className='pv6')], style={'padding':30, 'background-color':'#FFFFFF', 'border-radius': 5})
    ...
    bot_midSpace = html.Div([dcc.RadioItems(
        ...
        dcc.Loading(dcc.Graph(id='gdp_fig'),color='#45bf55', type='default', className='pv6')], style={'padding':30, 'background-color':'#FFFFFF', 'border-radius': 5})
