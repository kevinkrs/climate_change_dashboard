...
def p1_updateLayout():
    ...
    midSpace = html.Div(
        dcc.Loading(dcc.Graph(id='p1WorldMap'), type='default', className='pv6'), style={'padding':30, 'background-color':'#FFFFFF'} )
    
    bot_rightSpace = html.Div(
        dcc.Loading(dcc.Graph(id='p1WorldMap2'), type='default', className='pv6'),style={'padding':30, 'background-color':'#FFFFFF'})
    
    bot_leftSpace = html.Div(dcc.Loading(dcc.Graph(figure=temperature_page1()), type='default', className='pv6'),style={'padding':30, 'background-color':'#FFFFFF'})
