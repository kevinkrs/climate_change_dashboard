...
def get_world_graph_epo_relative():
    fig = px.line(df7, x="Year", y="Relative", color="Country", color_discrete_map= {'World' : '#24B33F'},
...
def get_world_graph_uspto_relative():
    fig = px.line(df8, x="Year", y="Relative", color="Country", color_discrete_map= {'World' : '#24B33F'},
...
def get_world_graph_pct_relative():
    fig = px.line(df9, x="Year", y="Relative", color="Country", color_discrete_map= {'World' : '#24B33F'},
                  hover_data=['Relative'], title = 'Ratio between Worldwide Environmental-Related applications and Worldwide Total applications ')
